#ifndef WEDITBUTTONHANDLER_H
#define WEDITBUTTONHANDLER_H
...
class wEditButtonHandler : public wEditHandler
{
    Q_OBJECT
 public:
    wEditButtonHandler(const screenMaker *s=0);
    QWidget *makeWidget(const QString &,QSize,QPoint,const fieldVals &);

};


#endif // WEDITBUTTONHANDLER_H
