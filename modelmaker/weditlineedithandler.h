#ifndef WEDITLINEEDITHANDLER_H
#define WEDITLINEEDITHANDLER_H
...
class wEditLineEditHandler : public wEditHandler
{
  Q_OBJECT
 public:
  wEditLineEditHandler(const screenMaker *s=0);
   QWidget *makeWidget(const QString &,QSize,QPoint,const fieldVals &);
};

#endif //WEDITLINEEDITHANDLER_H
