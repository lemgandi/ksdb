#ifndef WTEXTEDITINPUTHANDLER_H
#define WTEXTEDITINPUTHANDLER_H
...
class wTextEditInputHandler : public wInputHandler
{
   Q_OBJECT
   public:
      wTextEditInputHandler(QWidget *w=0);
   public slots:
