...
#import "wbuttonhandler.h"

//
// Make a button widget and return it.
//
QWidget *wButtonHandler::makeWidget(const QString &,QSize wSize,QPoint wLoc,const fieldVals &vals)
{
   QWidget *retVal = new QPushButton(vals["buttonLegend"],0,vals["buttonType"]);
